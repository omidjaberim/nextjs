...
const PresaleSection = ()=>{
    ...
    return (
      <Grid className="w-full max-w-[1440px] mx-auto py-[16px]" 
        style={{backgroundSize:'30%,25%',
            ...
            <Grid className="w-full flex  bg-black/33 relative "  >
              ...
              <Grid className="w-full relative px-[16px] md:px-0"  >            
                <div                
                  className="w-full font-Roboto flex flex-col md:flex-row justify-center md:justify-between  items-center md:items-center relative px-1"              
                  >
                    <div  className="z-20 pb-1 mt-[110px] flex flex-col items-start w-full">
                        <Grid  sx={typoStyle} className="w-full md:w-1/2 flex-col md:flex-row leading-relaxed font-Oxanium py-1 px-2 rounded-2xl" display={"flex"} flexWrap={"wrap"}  
                          gap={{ xs:"1px", md:"2px", xl:"8px" }} width={"100%"} >
                          <Title className="text-[70px] leading-[64px]"  ml={{lg:"8px" ,xs:"8px"}}  >META-V</Title>  
                          <Grid component="span" className="text-[60px] leading-[64px]"  ml={{lg:"8px" ,xs:"8px"}} >Epitomizes a</Grid>  
                          <Grid component="span" className="text-[60px] leading-[64px]"  ml={{lg:"8px" ,xs:"8px"}} sx={{
                                  color: "rgba(256,256,256,0.16)",
                                  WebkitTextFillColor: "rgba(256,256,256,0.16)",
                                  WebkitTextStroke: "1px white",
                          }} >Secound Life</Grid>
                        </Grid>
                        <Typography  sx={subTypeStyle} className="w-full md:w-1/2 font-Oxanium  py-2 px-5 rounded-2xl"  >
                            The convergence of reality and innovation, where aspirations are converted into digital realms.
                        </Typography>                 
                        <Grid className="bg-[#000000a8] rounded-2xl py-[20px] px-[4px] mt-[26px] ml-4" > 
                          <Stack
                            gap={{ xl: 2, md: 2, xs: 2 }}
                            maxWidth={"100%"}
                            px={{ xs: 0, sm: 4 }}
                      ...
                      <Grid className="flex justify-start my-[20px]" >
                        
                        <div className=" flex justify-center  ml-6" id="presale" >
                            <StyledButton>
                              <Link                                      
                                    href="https://twitter.com/META_V_Official" target="_blank" style={{textDecoration:'none'}}  >
                                <TwitterIcon className="hover:scale-110 text-black" />
                              </Link>
                            </StyledButton>
                        </div>
                        <div className="flex justify-center  mx-2" id="presale" >
                            <StyledButton>
                              <Link                                     
                                    href="https://t.me/META_V_Official" target="_blank" style={{textDecoration:'none'}}  >
                               <TelegramIcon className="hover:scale-110 text-black " />
                              </Link>
                            </StyledButton>
                        </div>
                        <div className="flex justify-center  " id="presale" >
                            <StyledButton>
                              <Link 
                                    className=" text-[#131315] leading-7 font-bold text-[18px] font-Oxanium"  
